...
/* Set a topbar icon label: MDI glyph when available, otherwise fallback text. */
...
static void ui_pages_create_topbar(lv_obj_t *screen)
{
    ...
    ui_pages_set_topbar_icon(s_gear_icon, MDI_CP_COG, LV_SYMBOL_SETTINGS);
    ...
    ui_pages_set_topbar_icon(s_wifi_icon, MDI_CP_WIFI_OFF, LV_SYMBOL_CLOSE);
}
